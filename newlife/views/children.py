...
from ..models import Child, Supporter
...
def children_list(request):
	...
	context = paginate(children, 2, request,{}, var_name = 'children')

	return render(request, 'children/children_list.html', context)

def children_edit(request, sid):

	return HttpResponse('<h1> Edit child %s </h1>' % sid)

def children_delete(request, sid):

	return HttpResponse('<h1> Delete child %s </h1>' % sid)
